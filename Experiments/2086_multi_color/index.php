                ...
                <div class="container-fluid js-tm-page-content" data-page-no="1" data-page-type="gallery">
                    <div class="tm-img-gallery-container">
                        <div class="tm-img-gallery gallery-one">
                            ...
                            // 각 변수 선언
                            // 변수에 할당된 정적인 값들은 DB로부터 얻어진다고 가정하자!!

                            $figure_titles[0] = "Image <span>One</span>";
                            $figure_titles[1] = "Image <span>Two</span>";
                            $figure_titles[2] = "Image <span>Three</span>";
                            $figure_titles[3] = "Image <span>Four</span>";

                            $figure_descriptions[0] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. - from php";
                            $figure_descriptions[1] = "Maecenas purus sem, lobortis id odio in sapien.";
                            $figure_descriptions[2] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.";
                            $figure_descriptions[3] = "Lorem ipsum dolor sit amet, consectetur adipiscing elit.";

                            $preview_urls[0] = "https://scontent-icn1-1.xx.fbcdn.net/v/t1.0-9/1962840_1578708305690956_1608391503261264296_n.jpg?_nc_cat=109&_nc_ht=scontent-icn1-1.xx&oh=84668b9967ea9b0fe98e5d9c735eb008&oe=5D0BD262";
                            $preview_urls[1] = "img/tm-img-02-tn.jpg";
                            $preview_urls[2] = "img/tm-img-03-tn.jpg";
                            $preview_urls[3] = "img/tm-img-04-tn.jpg";

                            $img_urls[0] = "https://scontent-icn1-1.xx.fbcdn.net/v/t1.0-9/1962840_1578708305690956_1608391503261264296_n.jpg?_nc_cat=109&_nc_ht=scontent-icn1-1.xx&oh=84668b9967ea9b0fe98e5d9c735eb008&oe=5D0BD262";
                            $img_urls[1] = "img/tm-img-02.jpg";
                            $img_urls[2] = "img/tm-img-03.jpg";
                            $img_urls[3] = "img/tm-img-04.jpg";
                            ...
                            ?>
                                ...
                                <div class="grid-item">
                                    <figure class="effect-bubba">
                                        <img src="<? echo $preview_urls[$i] ?>" alt="Image" class="img-fluid tm-img">
                                        <figcaption>
                                            <h2 class="tm-figure-title"><? echo $figure_titles[$i] ?></h2>
                                            <p class="tm-figure-description"><? echo $figure_descriptions[$i] ?></p>
                                            <a href="<? echo $img_urls[$i] ?>">View more</a>
                                        </figcaption>
                                    </figure>
                                </div>
                            ...
                            <div class="grid-item">
                                <figure class="effect-bubba">
                                    <img src="<? echo $preview_urls[0] ?>" alt="Image" class="img-fluid tm-img">
                                    <figcaption>
                                        <h2 class="tm-figure-title"><? echo $figure_titles[0] ?></h2>
                                        <p class="tm-figure-description"><? echo $figure_descriptions[0] ?></p>
                                        <a href="<? echo $img_urls[0] ?>">View more</a>
                                    </figcaption>
                                </figure>
                            </div>
                            <div class="grid-item">
