...
// 오늘 일자 중, 월(month) 정보 가져오기
$nowmonth = date('m');

if ($nowmonth < 2 || $nowmonth > 11) // 겨울
{
    $bgurl = "img/header-bg.jpg";
}
elseif ($nowmonth > 2 && $nowmonth < 6) // 봄
{
    $bgurl = "http://t1.daumcdn.net/liveboard/tourbaksa/67afa2f607344012bbbcbf7239388843.JPG";
}
elseif ($nowmonth > 5 && $nowmonth < 9) // 여름
{
    $bgurl = "https://erinewart.com/wp-content/uploads/2016/06/summer-01.jpg";
}
else // 가을
{
    $bgurl = "https://image.ytn.co.kr/general/jpg/2017/1006/201710060302305651_t.jpg";
}
?>

<header style="background: url('<?php echo $bgurl; ?>') no-repeat center center;">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
